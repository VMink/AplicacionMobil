...
EXEC InsertarNuevoDonante @A_PATERNO = 'Curiel', @A_MATERNO = 'López', @NOMBRE = 'Noemí Abigail', @FECHA_NAC = '1988-05-03', @EMAIL = 'noemi.curiel.donante@tec.mx', @ID_DIRECCION_COBRO = 4, @TEL_CASA = '+525567543247', @TEL_MOVIL = '+525552186232', @GENERO = 'F';
