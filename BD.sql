...
-- Crear OPE_DONANTES
EXEC InsertarNuevoDonante @A_PATERNO = 'Mireles', @A_MATERNO = 'Tellez', @NOMBRE = 'Gustavo', @FECHA_NAC = '1992-07-10', @EMAIL = 'gustavo.mireles.donante@tec.mx', @ID_DIRECCION_COBRO = 3, @TEL_CASA = 6667778888, @TEL_MOVIL = 7778889999, @GENERO = 'M';
EXEC InsertarNuevoDonante @A_PATERNO = 'Argueta', @A_MATERNO = 'Wolke', @NOMBRE = 'Maria Fernanda', @FECHA_NAC = '1985-11-20', @EMAIL = 'maferargueta@tec.mx', @ID_DIRECCION_COBRO = 1, @TEL_CASA = 4445556666, @TEL_MOVIL = 9990001111, @GENERO = 'M';
EXEC InsertarNuevoDonante @A_PATERNO = 'Lugo', @A_MATERNO = 'Quintana', @NOMBRE = 'Eduardo Francisco', @FECHA_NAC = '1980-03-15', @EMAIL = 'eduardo.lugo.donante@tec.mx', @ID_DIRECCION_COBRO = 2, @TEL_CASA = 5556667777, @TEL_MOVIL = 8889990000, @GENERO = 'Otro';
EXEC InsertarNuevoDonante @A_PATERNO = 'Curiel', @A_MATERNO = 'Lopez', @NOMBRE = 'Noemí Abigail', @FECHA_NAC = '1988-05-03', @EMAIL = 'noemi.curiel.donante@tec.mx', @ID_DIRECCION_COBRO = 4, @TEL_CASA = 7778889999, @TEL_MOVIL = 8889990000, @GENERO = 'F';
EXEC InsertarNuevoDonante @A_PATERNO = 'Danzos', @A_MATERNO = 'Garcia', @NOMBRE = 'Ramón Yuri', @FECHA_NAC = '1987-12-28', @EMAIL = 'ramon.danzos.donante@tec.mx', @ID_DIRECCION_COBRO = 5, @TEL_CASA = 8889990000, @TEL_MOVIL = 9990001111, @GENERO = 'M';
EXEC InsertarNuevoDonante @A_PATERNO = 'Lopez', @A_MATERNO = 'Hernandez', @NOMBRE = 'Carla', @FECHA_NAC = '1985-11-20', @EMAIL = 'carla.lopez.donante@tec.mx', @ID_DIRECCION_COBRO = 6, @TEL_CASA = 4445556666, @TEL_MOVIL = 9990001111, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Garza', @A_MATERNO = 'Martinez', @NOMBRE = 'Jose', @FECHA_NAC = '1977-08-18', @EMAIL = 'jose.gonzalez.donante@tec.mx', @ID_DIRECCION_COBRO = 7, @TEL_CASA = 8887776666, @TEL_MOVIL = 2223334444, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Perez', @A_MATERNO = 'Ramirez', @NOMBRE = 'Adrian', @FECHA_NAC = '1990-03-05', @EMAIL = 'adrian.perez.donante@tec.mx', @ID_DIRECCION_COBRO = 8, @TEL_CASA = 6665554444, @TEL_MOVIL = 5556667777, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Suarez', @A_MATERNO = 'Diaz', @NOMBRE = 'Rocio', @FECHA_NAC = '1984-06-27', @EMAIL = 'rocio.suarez.donante@tec.mx', @ID_DIRECCION_COBRO = 9, @TEL_CASA = 3334445555, @TEL_MOVIL = 5556667777 , @GENERO = "F";
EXEC InsertarNuevoDonante @A_PATERNO = 'Herrera', @A_MATERNO = 'Gomez', @NOMBRE = 'Maria', @FECHA_NAC = '1983-09-08', @EMAIL = 'maria.herrera.donante@tec.mx', @ID_DIRECCION_COBRO = 10, @TEL_CASA = 2223334444, @TEL_MOVIL = 8889990000, @GENERO = "F";
EXEC InsertarNuevoDonante @A_PATERNO = 'Maldonado', @A_MATERNO = 'Herrera', @NOMBRE = 'Francis', @FECHA_NAC = '1979-12-12', @EMAIL = 'francisco.maldonado.donante@tec.mx', @ID_DIRECCION_COBRO = 11, @TEL_CASA = 5556667777, @TEL_MOVIL = 1112223333, @GENERO = "F";
EXEC InsertarNuevoDonante @A_PATERNO = 'Gomez', @A_MATERNO = 'Fernandez', @NOMBRE = 'Paula', @FECHA_NAC = '1987-07-10', @EMAIL = 'paula.gomez.donante@tec.mx', @ID_DIRECCION_COBRO = 12, @TEL_CASA = 7778889999, @TEL_MOVIL = 1112223333, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Fernandez', @A_MATERNO = 'Torres', @NOMBRE = 'Pedro', @FECHA_NAC = '1986-09-18', @EMAIL = 'pedro.fernandez.donante@tec.mx', @ID_DIRECCION_COBRO = 13, @TEL_CASA = 8887776666, @TEL_MOVIL = 2223334444, @GENERO = "Otro";
EXEC InsertarNuevoDonante @A_PATERNO = 'Garcia', @A_MATERNO = 'Ruiz', @NOMBRE = 'Lucia', @FECHA_NAC = '1989-04-25', @EMAIL = 'lucia.garcia.donante@tec.mx', @ID_DIRECCION_COBRO = 14, @TEL_CASA = 6665554444, @TEL_MOVIL = 5556667777, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Smith', @A_MATERNO = 'Johnson', @NOMBRE = 'John', @FECHA_NAC = '1980-01-01', @EMAIL = 'john.smith.donante@tec.mx', @ID_DIRECCION_COBRO = 15, @TEL_CASA = 1234567890, @TEL_MOVIL = 5555555555, @GENERO = "F";
EXEC InsertarNuevoDonante @A_PATERNO = 'Johnson', @A_MATERNO = 'Smith', @NOMBRE = 'Mary', @FECHA_NAC = '1975-05-15', @EMAIL = 'mary.johnson.donante@tec.mx', @ID_DIRECCION_COBRO = 16, @TEL_CASA = 1112223333, @TEL_MOVIL = 7778889999, @GENERO = "M";
EXEC InsertarNuevoDonante @A_PATERNO = 'Rodriguez', @A_MATERNO = 'Garcia', @NOMBRE = 'Pedro', @FECHA_NAC = '1988-09-25', @EMAIL = 'pedro.rodriguez.donante@tec.mx', @ID_DIRECCION_COBRO = 17, @TEL_CASA = 9876543210, @TEL_MOVIL = 9998887777, @GENERO = "Otro";
EXEC InsertarNuevoDonante @A_PATERNO = 'Martinez', @A_MATERNO = 'Lopez', @NOMBRE = 'Ana', @FECHA_NAC = '1992-07-12', @EMAIL = 'ana.martinez.donante@tec.mx', @ID_DIRECCION_COBRO = 18, @TEL_CASA = 5554443333, @TEL_MOVIL = 1231231234, @GENERO = "F";
EXEC InsertarNuevoDonante @A_PATERNO = 'Santos', @A_MATERNO = 'Gutierrez', @NOMBRE = 'Luis', @FECHA_NAC = '1982-04-03', @EMAIL = 'luis.santos.donante@tec.mx', @ID_DIRECCION_COBRO = 19, @TEL_CASA = 7776665555, @TEL_MOVIL = 1112223333, @GENERO = "F";
-- Crear OPE_BITACORA_PAGOS_DONATIVOS
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2000, @ID_RECOLECTOR = 1, @ID_RECIBO = 123456, @FECHA_COBRO = '2023-10-18', @IMPORTE = 7187.50, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2069, @ID_RECOLECTOR = 2, @ID_RECIBO = 654321, @FECHA_COBRO = '2023-10-18', @IMPORTE = 7764.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2138, @ID_RECOLECTOR = 3, @ID_RECIBO = 987654, @FECHA_COBRO = '2023-10-18', @IMPORTE = 9247.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2207, @ID_RECOLECTOR = 4, @ID_RECIBO = 246813, @FECHA_COBRO = '2023-10-18', @IMPORTE = 6207.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2276, @ID_RECOLECTOR = 5, @ID_RECIBO = 135792, @FECHA_COBRO = '2023-10-18', @IMPORTE = 8334.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2345, @ID_RECOLECTOR = 4, @ID_RECIBO = 864209, @FECHA_COBRO = '2023-10-18', @IMPORTE = 1023.50, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2414, @ID_RECOLECTOR = 1, @ID_RECIBO = 128128, @FECHA_COBRO = '2023-10-18', @IMPORTE = 2824.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2483, @ID_RECOLECTOR = 2, @ID_RECIBO = 112233, @FECHA_COBRO = '2023-10-18', @IMPORTE = 6806.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2552, @ID_RECOLECTOR = 3, @ID_RECIBO = 445566, @FECHA_COBRO = '2023-10-18', @IMPORTE = 3254.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2621, @ID_RECOLECTOR = 1, @ID_RECIBO = 778899, @FECHA_COBRO = '2023-10-18', @IMPORTE = 9970.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2690, @ID_RECOLECTOR = 2, @ID_RECIBO = 789123, @FECHA_COBRO = '2023-10-18', @IMPORTE = 948.50, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2759, @ID_RECOLECTOR = 1, @ID_RECIBO = 256016, @FECHA_COBRO = '2023-10-18', @IMPORTE = 5919.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2828, @ID_RECOLECTOR = 5, @ID_RECIBO = 987123, @FECHA_COBRO = '2023-10-18', @IMPORTE = 2356.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';
EXEC InsertarNuevaBitacoraPagoDonativos @ID_DONANTE = 2897, @ID_RECOLECTOR = 4, @ID_RECIBO = 456321, @FECHA_COBRO = '2023-10-18', @IMPORTE = 5797.00, @ESTATUS_PAGO = 1, @COMENTARIOS = '';

--EXEC VerificarCredencialesRecolector @USUARIO = "gustavoRecolector", @PASS = "12345"; --Correcto
--EXEC VerificarCredencialesRecolector @USUARIO = "LOREMIPSUM", @PASS = "12345"; --Usuario no existe
--EXEC VerificarCredencialesRecolector @USUARIO = "gustavoRecolector", @PASS = "LOREMIPSUM"; --Incorrecto

--EXEC VerificarCredencialesManager @USUARIO = "Gustavoadmin", @PASS = "12345"; --Correcto
--EXEC VerificarCredencialesManager @USUARIO = "LOREMIPSUM", @PASS = "12345"; --Usuario no existe
--EXEC VerificarCredencialesManager @USUARIO = "Gustavoadmin", @PASS = "LOREMIPSUM"; --Incorrecto

--EXEC ObtenerDatosDiarios @IdRecolector = 2;

--EXEC ObtenerDatosDiariosManager;

--EXEC ActualizarBitacoraPagosDonativos @ID_BITACORA = 102, @ESTATUS_PAGO = 2, @COMENTARIOS = 'PAGADO, WOOO';
--EXEC ActualizarBitacoraPagosDonativos @ID_BITACORA = 108, @ESTATUS_PAGO = 3, @COMENTARIOS = 'Reprogramado para 23 octubre de 5 a 6 pm';
